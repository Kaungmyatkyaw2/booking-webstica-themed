...
const PromotionBox = ({img,title,para}) => {
  return (
    <div className='cursor-pointer flex sm:flex-row flex-col justify-center items-center w-[100%] rounded-[20px] overflow-x-hidden border dark:border-none dark:bg-[#191B1D] xl:h-[130px] md:h-[150px] max-h-[500px]'>
