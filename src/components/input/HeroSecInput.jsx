  ...
  return (
    <div className='flex items-center space-x-[10px] lg:w-[30%] w-[95%] '>
        ...
        <div className="w-full relative">
           ...
           <input onChange={handleChange} value={format} className={`px-[10px] py-[10px] pt-[20px] border border-[#C5C5C7] rounded-[10px] outline-none placeholder:text-[#999999] text-[15px] font-[500] w-full relative placeholder:font-[500]`} type={check ? 'date' : 'text'} placeholder={placeholder} />
        </div>
    </div>
