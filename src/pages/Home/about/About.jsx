  ...
  return (
    <div className='container-cus flex lg:flex-row flex-col lg:space-y-0 space-y-[60px]'>
        <div className="lg:w-[50%] w-full relative h-full">
            ...
            <div className='bg-white dark:bg-[#191B1D] absolute flex space-x-[30px] bottom-[30px] left-[30px] rounded-[20px] py-[15px] px-[20px]'>
        ...
        <div className='lg:w-[50%] w-full h-full'>
            ...
            <div className='w-full flex flex-wrap'>
               <ServiceCard card={card} width='w-[50%] w-full' classes='text-[20px] rounded-full' />
            </div>
        </div>
    </div>
  )
