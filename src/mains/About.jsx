...
const About = () => {
  ...
  return (
    <div className='w-full flex justify-center bg-white relative'>
        <div className='container-cus py-[20px] flex items-center font-dm '>
        <div className='xl:w-[25%] w-[50%]'>
            <img src="https://booking.webestica.com/assets/images/logo.svg" className='w-[130px]' alt="" />
        </div>
        <div className={`xl:w-[75%] w-full bg-white xl:flex ${show ? 'flex' : 'hidden'} xl:items-center xl:justify-center xl:space-x-[28px] xl:flex-row flex-col xl:relative absolute xl:top-0 top-[84%] left-0 xl:space-y-0 space-y-[20px] xl:py-0 py-[30px] xl:px-0 px-[50px] xl:shadow-none shadow-xl`}>
